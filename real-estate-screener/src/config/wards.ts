 ...
 * 区の平均路線価を取得 (円/㎡)
 */
export function getWardAvgRoadValue(ward: string): number {
  return wardProfiles[ward]?.avgRoadValuePerSqm ?? 400_000;
}
