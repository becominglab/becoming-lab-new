  ...
  return (
    <>
      ...
      <section className="py-16 bg-stone-50">
        <div className="max-w-2xl mx-auto px-8">
          <h2 className="text-xl font-bold text-gray-900 mb-4">会のあとに</h2>
          <div className="space-y-4 text-gray-600 leading-relaxed mb-6">
            <p>会が終わったあと、その日のことを note に書いています。</p>
            <p className="text-gray-500">来られなかった方も、次を想像する手がかりになれば。</p>
          </div>
          <Link href="/blog" className="text-sm hover:opacity-70 transition-opacity" style={{ color: "#1B6B7A" }}>
            読みものを見る →
          </Link>
        </div>
      </section>
