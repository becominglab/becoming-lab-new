...
export const metadata = {
  title: "サービス",
  description: "1on1セッション・神夫養成研究所・AI勉強会。自分の在り方を整え、人生の軸を見つけるプログラム。becoming lab。",
};
    ...
    <>
      ...
      <section className="pb-16">
        <div className="max-w-2xl mx-auto px-8">
          <div className="space-y-4 text-gray-600 leading-relaxed">
            ...
            <p className="text-gray-500">一人で向き合うか、夫婦で向き合うか、道具から変えるか。三つあります。</p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-20">
        <div className="max-w-2xl mx-auto px-8 space-y-16">
          ...
          <div className="pt-16 border-t border-stone-200">
            <p className="text-xs tracking-widest text-gray-400 mb-3">03　道具から変える</p>
            <h2 className="text-xl font-bold text-gray-900 mb-4">AI勉強会</h2>
            <div className="space-y-4 text-gray-600 leading-relaxed mb-6">
              <p>
                AIは、道具です。でも道具を手にしたとき、人は問われます。あなたは、何のために使うのか。
              </p>
              <p>
                becoming lab のAI勉強会は、技術の習得よりも先に、その問いを大切にします。自分の時間を取り戻すため。やりたいことに集中するため。自分で選んだ道を、もっと自分らしく歩くため。
              </p>
              <p className="py-4 border-l-2 border-stone-200 pl-6 text-gray-500">
